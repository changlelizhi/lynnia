...
public class UserController {
     ...
     */
    @PostMapping("/profile")
    public ApiResult<Void> updateProfile(@AuthenticationPrincipal String userId, @RequestHeader(value = "X-TMA-Init-Data", required = false) String initData) {
     ...
     */
    @GetMapping("/code")
    public ApiResult<String> sendLoginCode(@AuthenticationPrincipal String userId) {
        String code = userApi.sendVerificationCode(userId);
